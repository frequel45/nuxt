<template>
  <div class="sidebar-container">
    <div>
      <NuxtLink to="/home" class="sidebar-heading" :style="{ color: 'black', textDecoration: 'none' }">
      ...
      <div class="side-nav-links">
        <NuxtLink to="/home" class="sidebar-link">
          <img src="/board.svg" alt="" />
          <p>Board</p>
        </NuxtLink>
        <NuxtLink to="/analytics" class="sidebar-link">
          <GoDatabase />
          <p>Analytics</p>
        </NuxtLink>
    ...
    <div class="logout-button" @click="toggleLogout">
      <img src="/logout.svg" alt="" />
      <p>Logout</p>
    </div>

    <!-- Logout Confirmation Modal -->
    <div v-if="showLogoutConfirmation" class="overflow-container" @click="toggleLogout">
      <div class="overflow-mid-container">
        <div class="main-content" @click.stop>
          <p>Are you sure you want to, Logout?</p>
          <button @click="handleLogout">Yes, Logout</button>
...
import { useToast } from 'vue-toastification'; // for toast messages
import { useStore } from 'vuex';
import { deleteAllCookies } from '~/utils/cookieActions'; // assuming you have this utility
...
const handleLogout = () => {
  deleteAllCookies();
  store.dispatch('auth/clearLoggedInUser');
